    ...
    <section className="py-10">
      ...
      <div className="py-12">
            ...
            <div className=" gap-10 mt-1 col-span-11 md:col-span-9 pb-6">
              <div>
                ...
                <p className="text-text-secondary">
                  I am currently learning Cyber Security from the Online Free 
                  Platform. I am learning about the basic of Cyber Security,
                  Cyber Threats, Cyber Security Tools.
                </p>
        ...
        <div className="w-11/12 mx-auto">
          <div className=" grid grid-cols-12 gap-4 items-start">
            <div className="col-span-2 mt-3.5 hidden md:flex flex-col items-center justify-center h-full">
              <p className="text-nowrap">Mar 2022 — Present</p>
            </div>
            <div className=" flex flex-col items-center col-span-1 h-full">
              <h4 className="p-2 bg-project-card-background rounded-full flex items-center justify-center h-12 w-12">
                <svg
            ...
            <div className=" gap-10 mt-1 col-span-9 pb-6">
              <div>
                ...
                <p className="text-text-secondary">
                  Learning Electrical and Electronic Engineering from the
                  Shahjalal University of Science and Technology, Sylhet. I am
                  learning about the basic of Electrical and Electronic
                  Engineering, Digital Electronics, Microprocessor, and
                  Microcontroller.
                </p>
                <p className="flex gap-2 items-center text-text-secondary text-sm pt-2">
                  <FaUniversity className="text-button" />
        ...
        <div className="w-11/12 mx-auto">
          <div className=" grid grid-cols-12 gap-4 items-start">
            <div className="col-span-2 mt-3.5 hidden md:flex flex-col items-center justify-center h-full">
              <p className="text-nowrap">Jun 2018 — Jun 2020</p>
            </div>
            <div className=" flex flex-col items-center col-span-1 h-full">
              <h4 className="p-2 bg-project-card-background rounded-full flex items-center justify-center h-12 w-12">
                <svg
            ...
            <div className=" gap-10 mt-1 col-span-9 pb-6">
              <div>
                ...
                <p className="text-text-secondary">
                  My college was Border Guard Public School and College, Sylhet.
                  I have completed my Higher Secondary School Certificate (HSC)
                  from the Science Department.
                </p>
                <p className="flex gap-2 items-center text-text-secondary text-sm pt-2">
                  <FaUniversity className="text-button" />
                  Border Guard Public School and College, Sylhet(BGPSC)
                </p>
                <p className="text-nowrap flex md:hidden gap-2 mt-1 items-center text-text-secondary">
                  <IoTime className="text-button" />
                  <span>Jan 2022 — Present</span>
